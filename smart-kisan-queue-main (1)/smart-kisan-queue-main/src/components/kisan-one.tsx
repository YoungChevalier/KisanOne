...
import {
  ...
  Menu, MessageSquareText, Mic2, Pause, Phone, Play, RotateCcw, Scale, ScanLine,
...
function KisanShell() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <header className="sticky top-0 z-40 border-b border-header-border bg-header text-header-foreground shadow-sm">
        <div className="mx-auto flex h-16 max-w-[1600px] items-center gap-3 px-4 lg:px-6">
          ...
          <div className="flex min-w-0 items-center gap-3">
            <img src="/logo.png" alt="KisanOne Logo" className="size-9 shrink-0 rounded-md object-contain" />
            <div className="min-w-0"><div className="flex items-baseline gap-2"><strong className="text-lg">KisanOne</strong></div><p className="truncate text-[11px] text-header-subtle">One Platform. One Process. One Farmer.</p></div>
          </div>
      ...
      <Sheet open={mobileNav} onOpenChange={setMobileNav}><SheetContent side="left" className="w-72"><SheetHeader><SheetTitle><span className="flex items-center gap-2"><img src="/logo.png" alt="KisanOne Logo" className="size-7 rounded-sm object-contain" />KisanOne</span></SheetTitle><SheetDescription>Select an operational view.</SheetDescription></SheetHeader><div className="mt-6"><Navigation view={view} setView={(v) => { setView(v); setMobileNav(false); }} /></div></SheetContent></Sheet>
